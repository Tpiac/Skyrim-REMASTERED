...
Whole list was revisited. Many new features and improvements.

## Version 1.4.5

**Save-friendly**

Adjusted IED: gear nodes, aaded missile preset(selective) to display potions, excluded torch from displaying at all
